                                ...
                                <tbody>
                                            ...
                                            <tr>                              
                                                        <tr>
                                                            ...
                                                            <th></th>
                                                            <th></th>
                                                            <th><form action="php/excluirBarbeiro.php" method="POST"><button class="submit" name="id" value="" type="submit">Excluir</button></form></th>
                                                            <th><form action="editarBarbeiro.php" method="POST"><button class="submit" name="id" value="" type="submit">Editar</button></form></th>
                                                        </tr>
                                                  </tr>
...
<tr>                                   
                                                        <tr>
                                                            ...
                                                            <th></th>
                                                            <th></th>
                                                            <th><form action="php/excluirAdm.php" method="POST"><button class="submit" name="id" value="" type="submit">Excluir</button></form></th>
                                                            <th><form action="editarAdm.php" method="POST"><button class="submit" name="id" value="" type="submit">Editar</button></form></th>
                                                        </tr>
                                                  </tr>
